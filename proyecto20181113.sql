...
CREATE TABLE `usuario` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_usuario_especialidad_idx` (`especialidad`),
  KEY `FK_usuario_tipo_idx` (`tipo`),
  CONSTRAINT `FK_usuario_especialidad` FOREIGN KEY (`especialidad`) REFERENCES `especialidad` (`id`),
  CONSTRAINT `FK_usuario_tipo` FOREIGN KEY (`tipo`) REFERENCES `tipo` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-11-13 17:58:03
